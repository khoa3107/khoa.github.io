...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi gia đình!";
    let charArrTitle = textTitle.split('');
let text = "Chúc mọi người có thật nhiều niềm vui cùng bạn bè, người thân và đạt được nhiều thành công trong năm tới. MERRY CHRISTMAS"
